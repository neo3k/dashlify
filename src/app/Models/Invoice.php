...
class Invoice extends Model
{
    ...
    /**
     * Set formatted_next_recurring_at attribute by custom date format
     * from Company Settings
     *
     * @return string
     */
    public function getFormattedNextRecurringAtAttribute($value)
    {
        $dateFormat = CompanySetting::getSetting('date_format', $this->company_id);
        return Carbon::parse($this->next_recurring_at)->format($dateFormat);
    }
    ...
    /**
     * Scope a query to only return Paid Invoices
     *
     * @param \Illuminate\Database\Eloquent\Builder  $query
     *
     * @return \Illuminate\Database\Eloquent\Builder
