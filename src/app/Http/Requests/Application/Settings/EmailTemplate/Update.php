...
class Update extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'invoice_due_mail_subject' => 'required|string',
            'invoice_due_mail_content' => 'required|string',
            'invoice_overdue_mail_subject' => 'required|string',
            'invoice_overdue_mail_content' => 'required|string',
