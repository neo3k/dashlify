...
class DueInvoiceToCustomer extends Mailable
{
    ...
    {
        $subject = $this->replaceTags($this->company->getSetting('invoice_due_mail_subject'));
        $mail_content = $this->replaceTags($this->company->getSetting('invoice_due_mail_content'));
