                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            ...
                            <![endif]-->
                                            <img style="width: 180px; margin: 0 0 15px 0; padding-right: 30px; padding-left: 0px;" width="180" src="{{ asset(get_system_setting('application_logo')) }}" />

                                            {!! $mail_content !!}

                                            <a class="cta-link" href="{{ url('/') }}" target="_blank">
                                                {{ __('messages.click_to_login') }}             
                                            </a>
                            <!--[if mso]>
                                        </td>
                                        <td style="padding: 0; margin: 0;">&nbsp;</td>
