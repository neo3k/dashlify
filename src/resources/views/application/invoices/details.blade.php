...
@section('content') 
    <div class="row">
        ...
        <div class="col-12">
            @if ($invoice->is_recurring and $invoice->cyle != 0)
                <div class="alert alert-soft-success d-flex align-items-center" role="alert">
                    <i class="material-icons mr-3">schedule</i>
                    <div class="text-body"><strong>{{ __('messages.recurring') }} : </strong> Next invoice are going to issue at {{ $invoice->formatted_next_recurring_at }}</div>
                </div>
            @endif
        </div>
        <div class="col-12">
