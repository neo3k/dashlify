    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }} d-none">
                    <label for="app_name">
                        {{ trans('installer_messages.environment.wizard.form.app_name_label') }}
                    </label>
                    <input type="text" name="app_name" id="app_name" value="Foxtrot" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }} d-none">
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }} d-none">
                    <label for="app_debug">
                ...
                <div class="form-group {{ $errors->has('app_log_level') ? ' has-error ' : '' }} d-none">
