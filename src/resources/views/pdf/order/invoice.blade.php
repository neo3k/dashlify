        ...
        <table width="100%">
            <tr>
                ...
                <td width="60%" class="header-section-left">
                    <img class="header-logo" src="{{ asset(get_system_setting('application_logo')) }}">
                    @else
                <td width="60%" class="header-section-left" style="padding-top: 0px;">
                    <h1 class="header-logo"> {{ get_system_setting('application_name') }} </h1>
                    @endif
                </td>
                <td width="40%" class="header-section-right invoice-details-container">
                    <h1>{{ __('messages.invoice') }}</h1>
                    <h4>{{$order->order_id}}</h4>
                    <h4>{{ __('messages.invoice_date') }}: {{$order->created_at->format($dateFormat)}}</h4>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="content-wrapper">
        <table width="100%" class="items-table" cellspacing="0" border="0">
            <tr class="item-table-heading-row">
                <th width="2%" class="pr-20 text-left item-table-heading">#</th>
                <th class="pr-20 text-left item-table-heading">{{ __('messages.transaction_id') }}</th>
                <th class="pr-20 text-left item-table-heading">{{ __('messages.plan') }}</th>
                <th class="pr-20 text-center item-table-heading">{{ __('messages.payment_type') }}</th>
            ...
            <tr class="item-row">
                ...
                <td class="pr-20 text-left item-cell" style="vertical-align: top;">
                    @if($order->plan)
                        <a class="mb-0">{{ $order->plan->name ?? '-' }}</a>
                    @else
                        <a class="mb-0">-</a>
                    @endif
                </td>
