...
// Static Pages
Route::get('/pages/{slug}', 'PageController@index')->middleware('installed')->name('pages');

// Landing
Route::get('/', 'HomeController@index')->middleware('installed')->name('home');
Route::get('/demo', 'HomeController@demo')->middleware('installed')->name('demo');
Route::get('/change-language/{locale}', 'HomeController@change_language')->middleware('installed')->name('change_language');
